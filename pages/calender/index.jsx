...
const Index = () => {
  ...
  const handleSave = async (e) => {
    ...
    const querySnapshot = await getDocs(subCollectionRef.current);
    const courseExists = querySnapshot.docs.some((doc) => doc.data().course_code === selectedCourse.courseCode);

    if (courseExists) {
      alert("You already have a listing for this course.");
  ...
  return (
    <div className={styles.create}>
      <h2 className={styles.createh2}>
        Become a Tutor for {selectedCourse.courseCode} -{" "}
